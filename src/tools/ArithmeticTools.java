...
/**
 *
 * @author Intelligent Systems Laboratory at the University of Bristol
 */
public class ArithmeticTools {
    ...
    /**
     * Method which calculates natural logarithm for BigDecimal. If number is
     * smaller than Double.MAX_VALUE, then Math.log is used, otherwise
     * BigDecimals with v.divide(TWO).add(LNTWO).
     *
     * @param v
     * @return
     */
    ...
    /**
     * Method which calculates natural logarithm for BigInteger. BigDecimals are
     * used.
     *
     * @param v
     * @return
    ...
    /**
     * Method which calculates logarithm base2 for BigDecimal. If number is
     * smaller than Double.MAX_VALUE, then Math.log(x)/Math.log(2) is used,
    ...
    /**
     * Method which calculates logarithm base10 for BigDecimal. If number is
     * smaller than Double.MAX_VALUE, then Math.log is used, otherwise
     * BigDecimal with v.divide(TEN).add(LOGTEN).
     *
     * @param v
     * @return
     */
